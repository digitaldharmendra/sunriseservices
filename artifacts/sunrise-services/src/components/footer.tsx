...
export function Footer() {
  return (
    <footer className="bg-[#0b101a] pt-20 pb-10 border-t border-white/5 text-gray-400">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            <a href="#" className="flex items-center gap-3 mb-6">
              ...
              <div className="font-serif font-bold text-xl leading-none tracking-wide text-white">
                SUNRISE<br /><span className="text-sm font-sans font-medium opacity-80 text-gray-300">SERVICES</span>
              </div>
            </a>
            <p className="max-w-md text-gray-400 leading-relaxed mb-8">
              A registered trust and non-profit NGO committed to positive change, sustainability, and community empowerment across Delhi and beyond.
            </p>
            <div className="flex items-center gap-4">
              <span className="text-sm font-bold text-white uppercase tracking-wider">Follow Us</span>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#mission" className="hover:text-primary transition-colors inline-block">Our Mission</a></li>
              <li><a href="#focus-areas" className="hover:text-primary transition-colors inline-block">Focus Areas</a></li>
              <li><a href="#programs" className="hover:text-primary transition-colors inline-block">Programs</a></li>
              <li><a href="#team" className="hover:text-primary transition-colors inline-block">Our Team</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
          <p>&copy; {new Date().getFullYear()} Sunrise Services. All rights reserved.</p>
          <p>Registered NGO in Delhi, India.</p>
        </div>
      </div>
    </footer>
  );
